  ...
  return (
    <AnimatePresence>
      <>
        ...
        {/* Modal Container - Centers the modal and handles max dimensions */}
        <motion.div
        ...
        >
          <div className="min-h-full flex items-center justify-center p-4">
            {/* Modal Content */}
            <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[calc(100vh-32px)] md:max-h-[calc(100vh-10vh)] overflow-hidden relative flex flex-col">
              {/* Header */}
